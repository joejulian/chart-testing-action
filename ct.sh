...
DEFAULT_CHART_TESTING_VERSION=3.9.0-4
...
install_chart_testing() {
    ...
    if [[ ! -d "${cache_dir}" ]]; then
        ...
        CT_CERT=https://github.com/joejulian/chart-testing/releases/download/v$version/chart-testing_${version#v}_linux_$arch.tar.gz.pem
        CT_SIG=https://github.com/joejulian/chart-testing/releases/download/v$version/chart-testing_${version#v}_linux_$arch.tar.gz.sig
